...
import org.training.initialdata.constants.MystoreInitialDataConstants;
	...
	{
		{
			...
			electronicsImportData.setProductCatalogName(MYSTORE);
			electronicsImportData.setContentCatalogNames(Arrays.asList(MYSTORE));
			electronicsImportData.setStoreNames(Arrays.asList(MYSTORE));
